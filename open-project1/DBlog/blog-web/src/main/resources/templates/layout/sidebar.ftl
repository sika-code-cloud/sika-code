<div class="col-sm-3 blog-sidebar">
    ...
    <#else>
        <div class="sidebar-module" style="position: relative;">
            <a href='https://github.com/sika-code/sika-code' target="_blank" rel="external nofollow"><img src='https://gitee.com/yadong.zhang/DBlog/widgets/widget_1.svg?color=07b83f' alt='Fork me on Github' style="position: absolute;right: 0;"/></a>
    ...
    <div class="sidebar-module">
        ...
        <ul class="ul-default site-info">
            <@zhydTag method="siteInfo">
                ...
                <li> <i class="fa fa-users fa-fw"></i> 在线人数：<span class="online">98</span>人</li>
