    ...
    <div class="container">
        <div class="row">
            <div class="col col-xs-12 col-md-12 col-lg-12">
                ...
                <p><#if config.copyright!>${config.copyright} |</#if> Powered by <a href="https://gitee.com/yadong.zhang/DBlog" title="开源改变世界，SikaCode让世界没有难写的代码..." data-toggle="tooltip" data-placement="right" target="_blank"><i>OneBlog</i></a>  </p>
                <#if url?? && (url == "index")>
