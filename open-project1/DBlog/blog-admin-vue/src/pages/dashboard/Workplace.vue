    ...
    <div class="bg-white q-pa-md" style="margin: -16px -16px 0 -16px">
      ...
      <div class="row items-center q-gutter-y-sm">
        ...
        <div class="col-xs-12 col-sm-9 col-md-6 q-pl-md">
          <div style="font-size: large" class="q-mb-xs">早安，Serati Ma，祝你开心每一天！</div>
          <q-item-label class="text-grey-6 text-body">交互专家 |蚂蚁金服－某某某事业群－某某平台部－某某技术部－UED</q-item-label>
        </div>
        <div class="col-xs-12 col-md-5 text-grey-6 text-body q-gutter-x-lg"
          ...
          <q-item-label class="inline-block">
            <q-item-label>
              <q-avatar color="blue-1" size="sm" text-color="primary" class="q-mr-sm" icon="apps"></q-avatar>
              <span>项目数</span>
            </q-item-label>
            <q-item-label class="text-center text-black q-pt-xs" style="font-size: x-large">56</q-item-label>
          </q-item-label>
          <q-item-label class="inline-block">
            <q-item-label>
              <q-avatar color="orange-1" size="sm" text-color="orange" class="q-mr-sm" icon="edit"></q-avatar>
              <span>待办项</span>
            </q-item-label>
            <q-item-label class="text-center text-black q-pt-xs" style="font-size: x-large">8/24</q-item-label>
          </q-item-label>
          <q-item-label class="inline-block">
            <q-item-label>
              <q-avatar color="green-1" size="sm" text-color="green" class="q-mr-sm" icon="visibility"></q-avatar>
              <span>项目访问</span>
            </q-item-label>
            <q-item-label class="text-center text-black q-pt-xs" style="font-size: x-large">2,223</q-item-label>
          </q-item-label>
        </div>
      </div>
    </div>
    <div class="q-mt-md row">
      <div class="col-lg-8 col-xs-12 q-mb-md">
        ...
        <q-card flat class="no-border-radius q-mt-md q-pb-md">
          <q-card-section class="bg-white">
            <q-avatar color="purple-1" size="sm" text-color="purple" class="q-mr-sm" icon="highlight"></q-avatar>
            <span>
            动态
          </span>
          </q-card-section>
            ...
            <div v-for="contact in items" :key="contact.id" class="q-mb-sm">
              <q-item class="q-py-md">
                ...
                <q-item-section>
                  ...
                  <q-item-label class="text-grey-6" lines="1">2020-12-21 21:11:21</q-item-label>
                </q-item-section>
              </q-item>
              <q-separator inset="" />
            </div>
      ...
      <div class="col-lg-4 col-xs-12" :class="{'q-pl-md': $q.screen.gt.md}">
        <q-card flat class="no-border-radius q-mb-md">
          <q-card-section class="bg-white">
            <q-avatar color="red-1" size="sm" text-color="red" class="q-mr-sm" icon="favorite"></q-avatar>
            <span>
            快捷操作
          </span>
          </q-card-section>
          ...
          <q-list>
            <q-card-section class="q-mb-sm row">
              ...
              <div class="q-py-md  col-4">
                <q-item-section avatar style="align-items: center">
                  <q-avatar font-size="28px" icon="list_alt" text-color="primary">
                  </q-avatar>
                  <div>表单</div>
                </q-item-section>
              </div>
              <div class="q-py-md col-4">
                <q-item-section avatar style="align-items: center">
                  <q-avatar font-size="28px" icon="grid_on" text-color="warning">
                  </q-avatar>
                  列表
                </q-item-section>
              </div>
              ...
              <div class="q-py-md col-4">
                <q-item-section avatar style="align-items: center">
                  <q-avatar font-size="28px" icon="settings_applications" text-color="green">
                  </q-avatar>
                  设置
                </q-item-section>
              </div>
              <div class="q-py-md col-4">
                <q-item-section avatar style="align-items: center">
                  <q-avatar font-size="28px" icon="home_repair_service" text-color="negative">
                  </q-avatar>
                  <div>工具</div>
                </q-item-section>
              </div>
            ...
            <div class="q-pa-md row text-center items-center q-gutter-y-sm">
              ...
              <span class="col-3">
                  <q-btn size="sm" padding="2px 15px" style="border: 1px solid deepskyblue" color="primary" flat
                         label="添加"
                         :ripple="false"></q-btn>
                </span>
            </div>
        ...
        <q-card flat class="no-border-radius q-mb-md">
          <q-card-section class="bg-white">
            <q-avatar color="green-1" size="sm" text-color="green" class="q-mr-sm" icon="group"></q-avatar>
            <span>
            小组成员
            </span>
          </q-card-section>
          ...
          <q-list>
            <q-item class="q-mb-sm" v-for="item in 10" :key="item">
              ...
              <q-item-section side>
                <q-chip v-if="item % 4 === 1" outline square color="blue" class="bg-blue-1" label="在" style="width: 56px"/>
                <q-chip v-if="item % 4 === 2" outline square color="green" class="bg-green-1" label="不在" style="width: 56px"/>
                <q-chip v-if="item % 4 === 3" outline square color="red" class="bg-red-1" label="不在" style="width: 56px"/>
                <q-chip v-if="item % 4 === 0" outline square color="purple" class="bg-purple-1" label="在" style="width: 56px"/>
              </q-item-section>
            </q-item>
          </q-list>
        </q-card>
