 ...
 */
@Configuration
@ConditionalOnProperty(value = "sika.code.httpRequest.fire", havingValue = "true", matchIfMissing = true)
public class HttpRequestConfig {

    @Bean
    @ConditionalOnProperty(value = "sika.code.httpRequest.filter.fire", havingValue = "true", matchIfMissing = true)
