package com.sika.code.standard.footer.demo.business.creditquotausagetemplate.convert;
...
public interface CreditQuotaUsageTemplateConvert extends BaseConvert<CreditQuotaUsageTemplateEntity, CreditQuotaUsageTemplateDTO> {
     ...
     * @date 2019-06-07 10:12:50
     */
    CreditQuotaUsageTemplateDTO convertToDTO(CreditQuotaUsageTemplateSaveRequestBO.CreditQuotaUsageTemplateSaveRequest request);
     ...
     */
    CreditQuotaUsageTemplateDTO convertToDTO(CreditQuotaUsageTemplateSaveBatchRequestBO.CreditQuotaUsageTemplateSaveBatchRequest request);
     ...
     * @date 2019/6/19 20:29
     */
    List<CreditQuotaUsageTemplateDTO> convertToDTOFromSaveBatchRequests(List<CreditQuotaUsageTemplateSaveBatchRequestBO.CreditQuotaUsageTemplateSaveBatchRequest> requests);
     ...
     * @date 2019-06-07 10:12:50
     */
    CreditQuotaUsageTemplateDTO convertToDTO(CreditQuotaUsageTemplateUpdateByIdRequestBO.CreditQuotaUsageTemplateUpdateByIdRequest request);
     ...
     * @date 2019-06-07 10:12:50
     */
    CreditQuotaUsageTemplatePageQueryResponseBO.CreditQuotaUsageTemplatePageQueryResponse convertToPageQueryResponse(CreditQuotaUsageTemplateDTO dto);
     ...
     * @date 2019-06-07 10:12:50
     */
    List<CreditQuotaUsageTemplatePageQueryResponseBO.CreditQuotaUsageTemplatePageQueryResponse> convertToPageQueryResponses(List<CreditQuotaUsageTemplateDTO> dtos);
     ...
     * @date 2019-06-07 10:12:50
     */
    CreditQuotaUsageTemplateListQueryResponseBO.CreditQuotaUsageTemplateListQueryResponse convertToListQueryResponse(CreditQuotaUsageTemplateDTO dto);
     ...
     * @date 2019-06-07 10:12:50
     */
    List<CreditQuotaUsageTemplateListQueryResponseBO.CreditQuotaUsageTemplateListQueryResponse> convertToListQueryResponses(List<CreditQuotaUsageTemplateDTO> dtos);
     ...
     * @date 2019-06-07 10:12:50
     */
    CreditQuotaUsageTemplateQueryResponseBO.CreditQuotaUsageTemplateQueryResponse convertToQueryResponse(CreditQuotaUsageTemplateDTO dto);
