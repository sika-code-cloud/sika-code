...
public class ConfigParserHandler {
    ...
    public Map<Object, Object> parseConfig(String content, String configFileType) throws IOException {
        return parseConfig(content, ConfigFileTypeEnum.of(configFileType));
    }
