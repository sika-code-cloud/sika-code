 ...
 */
public class DqGenerateJavaClassRule implements DqGenerateRule {
	/** 生成Get方法 */
	...
	public DqGenerateJavaClassRule(boolean generateField, boolean generateGetMethod, boolean generateSetMethod,
	...
	public DqGenerateJavaClassRule buildGenerateGetMethod(boolean generateGetMethod) {
		this.generateGetMethod = generateGetMethod;
		return this;
	}
	public DqGenerateJavaClassRule buildGenerateSetMethod(boolean generateSetMethod) {
		this.generateSetMethod = generateSetMethod;
		return this;
	}
	public DqGenerateJavaClassRule buildGenerateBuildMethod(boolean generateBuildMethod) {
		this.generateBuildMethod = generateBuildMethod;
		return this;
	}
}
