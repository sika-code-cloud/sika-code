...
public class DqCodeGenerateUtils {
	...
	private void generateDOFileUseDTO(ResultSet resultSet) throws Exception {
		DqCodeGenerateDatabaseDTO dqCodeGenerateDatabaseDTO = new DqCodeGenerateDatabaseDTO();

		dqCodeGenerateDatabaseDTO.setFileSuffix(DqFileSuffix.JAVA);
		dqCodeGenerateDatabaseDTO.setModelBasePackageName(packageName);
		dqCodeGenerateDatabaseDTO.setSubModuleRelativePackageName("pojo.po");
...
//		dqCodeGenerateDatabaseDTO.setClassNameEndWith("Entity");
		dqCodeGenerateDatabaseDTO.setTemplateName("POJO_DO1.ftl");
		dqCodeGenerateDatabaseDTO.setFileComment("用户");
	 ...
	 * @return
	 * @author daiqi 创建时间 2018年3月22日 下午7:25:53
	 */
	public static String getPackagePathFull(DqCodeGenerateBaseDTO codeGenerateBaseDTO) {
		...
		packageFullPathBuild.append(codeGenerateBaseDTO.getSourceFilePathFull());
	 ...
	 * @param codeGenerateBaseDTO
	 * @return
	 * @author daiqi 创建时间 2018年3月22日 下午7:28:16
	 */
	public static String getFilePathFull(DqCodeGenerateBaseDTO codeGenerateBaseDTO) {
		...
		if (DqStringUtils.isNotEmpty(codeGenerateBaseDTO.getClassNameBody())) {
			fileFullPathBuild.append(codeGenerateBaseDTO.getClassNameBody());
		}
		...
		fileFullPathBuild.append(codeGenerateBaseDTO.getFileSuffix());
	 ...
	 * @param codeGenerateBaseDTO
	 * @return
	 * @author daiqi 创建时间 2018年3月22日 下午8:15:24
	 */
	 ...
	 * @param codeGenerateBaseDTO
	 * @return
	 * @author daiqi 创建时间 2018年3月22日 下午8:35:15
	 */
	...
	public static String getSourceFilePathFull(DqCodeGenerateBaseDTO codeGenerateBaseDTO) {
		StringBuilder sourceFilePathBuild = DqStringUtils.newStringBuilderDefault();
		if (DqStringUtils.isNotEmpty(codeGenerateBaseDTO.getProjectRootPath())) {
			sourceFilePathBuild.append(codeGenerateBaseDTO.getProjectRootPath());
		} else {
			sourceFilePathBuild.append(DqCodeProject.PROJECT_ROOT_BASE_PATH_DEFAULT);
		}
		
		if (DqStringUtils.isNotEmpty(codeGenerateBaseDTO.getSourceFilePathRelative())) {
			sourceFilePathBuild.append(codeGenerateBaseDTO.getSourceFilePathRelative());
		} else {
			if (DqFileSuffix.isJava(codeGenerateBaseDTO.getFileSuffix())) {
				sourceFilePathBuild.append(DqSourceCodePathRelative.JAVA);
			} else if (DqFileSuffix.isXml(codeGenerateBaseDTO.getFileSuffix())) {
				sourceFilePathBuild.append(DqSourceCodePathRelative.RESOURCES);
			}
		}
		return sourceFilePathBuild.toString();
	}
