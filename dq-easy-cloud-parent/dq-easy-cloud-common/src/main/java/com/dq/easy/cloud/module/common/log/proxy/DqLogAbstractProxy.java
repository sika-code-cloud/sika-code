package com.dq.easy.cloud.module.common.log.proxy;
...
import com.dq.easy.cloud.module.common.log.constant.DqLogConstant.DqLogMode;
import com.dq.easy.cloud.module.common.log.pojo.bo.DqLogAnalysisBO;
import com.dq.easy.cloud.module.common.log.pojo.bo.DqLogBO;
...
import com.dq.easy.cloud.module.common.log.utils.DqLogAnalysisUtils;
 ...
 */
public abstract class DqLogAbstractProxy implements DqLogProxy {

	protected final Logger logger = LoggerFactory.getLogger(DqLogBaseProxy.class);
	/** 日志数据传输对象 */
...
//		初始化日志分析数据
	...
	protected void doLogAnalysis(){
		...
		DqLogUtils.info("日志分析数据", dqLogAnalysisBO, logger);
	}
