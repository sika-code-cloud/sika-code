...
@Entity
public class GoodsEntity extends DqBaseBO{
	/** 角色售卖订单号 */
	...
	/** 构建角色售卖订单号 */
	public GoodsEntity buildRoleSerialNum(Long roleSerialNum) {
		this.roleSerialNum = roleSerialNum;
		return this;
	}
	...
	/** 构建实际的Icon路径 */
	public GoodsEntity buildActualIcon(String actualIcon) {
		this.actualIcon = actualIcon;
		return this;
	}
	...
	/** 构建数据编号 */
	public GoodsEntity buildDataId(Long dataId) {
		this.dataId = dataId;
		return this;
	}
	...
	/** 构建ext_type */
	public GoodsEntity buildExtType(Integer extType) {
		this.extType = extType;
		return this;
	}
	...
	/** 构建贵重标志0 不是贵重 1 贵重 */
	public GoodsEntity buildGuiZhong(Integer guiZhong) {
		this.guiZhong = guiZhong;
		return this;
	}
	...
	/** 构建图片位置 此为相对位置 */
	public GoodsEntity buildIcon(String icon) {
		this.icon = icon;
		return this;
	}
	...
	/** 构建是否绑定 0 否 1 是 */
	public GoodsEntity buildIsBind(Integer isBind) {
		this.isBind = isBind;
		return this;
	}
	...
	/** 构建is_gem */
	public GoodsEntity buildIsGem(Integer isGem) {
		this.isGem = isGem;
		return this;
	}
	...
	/** 构建名称 */
	public GoodsEntity buildName(String name) {
		this.name = name;
		return this;
	}
	...
	/** 构建数量 */
	public GoodsEntity buildNum(Integer num) {
		this.num = num;
		return this;
	}
	...
	/** 构建position */
	public GoodsEntity buildPos(Integer pos) {
		this.pos = pos;
		return this;
	}
	...
	/** 构建类型描述 */
	public GoodsEntity buildTypeDesc(String typeDesc) {
		this.typeDesc = typeDesc;
		return this;
	}
	...
	/** 构建use_time_desc */
	public GoodsEntity buildUseTimeDesc(String useTimeDesc) {
		this.useTimeDesc = useTimeDesc;
		return this;
	}
	...
	/** 构建use_time_desc2 */
	public GoodsEntity buildUseTimeDesc2(String useTimeDesc2) {
		this.useTimeDesc2 = useTimeDesc2;
		return this;
	}
