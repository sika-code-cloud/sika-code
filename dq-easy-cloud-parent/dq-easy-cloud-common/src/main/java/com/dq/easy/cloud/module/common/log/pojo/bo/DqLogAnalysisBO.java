package com.dq.easy.cloud.module.common.log.pojo.bo;

import java.util.Map;

import com.dq.easy.cloud.module.basic.utils.DqBaseUtils;
import com.dq.easy.cloud.module.common.log.constant.DqLogErrorCodeEnum;
...
public class DqLogAnalysisBO {
	...
	public DqLogAnalysisBO buildDqLogAnalysisData() {
		...
		if (DqBaseUtils.isNull(dqLogDTO)) {
			throw DqBaseBusinessException.newInstance(DqLogErrorCodeEnum.DQ_LOG_DTO_CANT_NULL);
		}
