...
@Entity
public class TlCygGoodsInfo extends DqBaseBO{
	/** 角色售卖订单号 */
	...
	/** 构建角色售卖订单号 */
	public TlCygGoodsInfo buildRoleSerialNum(Long roleSerialNum) {
		this.roleSerialNum = roleSerialNum;
		return this;
	}
	...
	/** 构建实际的Icon路径 */
	public TlCygGoodsInfo buildActualIcon(String actualIcon) {
		this.actualIcon = actualIcon;
		return this;
	}
	...
	/** 构建数据编号 */
	public TlCygGoodsInfo buildDataId(Long dataId) {
		this.dataId = dataId;
		return this;
	}
	...
	/** 构建ext_type */
	public TlCygGoodsInfo buildExtType(Integer extType) {
		this.extType = extType;
		return this;
	}
	...
	/** 构建贵重标志0 不是贵重 1 贵重 */
	public TlCygGoodsInfo buildGuiZhong(Integer guiZhong) {
		this.guiZhong = guiZhong;
		return this;
	}
	...
	/** 构建图片位置 此为相对位置 */
	public TlCygGoodsInfo buildIcon(String icon) {
		this.icon = icon;
		return this;
	}
	...
	/** 构建是否绑定 0 否 1 是 */
	public TlCygGoodsInfo buildIsBind(Integer isBind) {
		this.isBind = isBind;
		return this;
	}
	...
	/** 构建is_gem */
	public TlCygGoodsInfo buildIsGem(Integer isGem) {
		this.isGem = isGem;
		return this;
	}
	...
	/** 构建名称 */
	public TlCygGoodsInfo buildName(String name) {
		this.name = name;
		return this;
	}
	...
	/** 构建数量 */
	public TlCygGoodsInfo buildNum(Integer num) {
		this.num = num;
		return this;
	}
	...
	/** 构建position */
	public TlCygGoodsInfo buildPos(Integer pos) {
		this.pos = pos;
		return this;
	}
	...
	/** 构建类型描述 */
	public TlCygGoodsInfo buildTypeDesc(String typeDesc) {
		this.typeDesc = typeDesc;
		return this;
	}
	...
	/** 构建use_time_desc */
	public TlCygGoodsInfo buildUseTimeDesc(String useTimeDesc) {
		this.useTimeDesc = useTimeDesc;
		return this;
	}
	...
	/** 构建use_time_desc2 */
	public TlCygGoodsInfo buildUseTimeDesc2(String useTimeDesc2) {
		this.useTimeDesc2 = useTimeDesc2;
		return this;
	}
