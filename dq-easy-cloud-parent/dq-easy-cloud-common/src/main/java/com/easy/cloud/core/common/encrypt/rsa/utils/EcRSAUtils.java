...
package com.dq.easy.cloud.module.common.encrypt.rsa.utils;

import javax.crypto.Cipher;

import com.dq.easy.cloud.module.common.encrypt.base64.utils.DqBase64Utils;
...
public class DqRSAUtils{
	...
	public static String sign(String content, String privateKey, String signAlgorithms, String characterEncoding) {
		try {
			PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(DqBase64Utils.decode(privateKey));
			...
			return DqBase64Utils.encode(signed);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	*/
	public static String decrypt(String content, String privateKey, String characterEncoding) throws Exception {
        ...
        InputStream ins 	= new ByteArrayInputStream(DqBase64Utils.decode(content));
	...
	*/
	public static PrivateKey getPrivateKey(String key) throws Exception {
		...
		byte[] keyBytes;
		keyBytes = DqBase64Utils.decode(key);
