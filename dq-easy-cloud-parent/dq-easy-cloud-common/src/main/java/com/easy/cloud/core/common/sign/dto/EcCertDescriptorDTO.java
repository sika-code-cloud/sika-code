 ...
 * =============================================================================
 */
package com.dq.easy.cloud.module.common.sign.dto;
...
/**
 * acpsdk证书工具类，主要用于对证书的加载和使用 date 2016-7-22 下午2:46:20
 * 声明：以下代码只是为了方便接入方测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障
 */
public class DqCertDescriptorDTO {
	protected static final Log log = LogFactory.getLog(DqCertDescriptorDTO.class);
	...
	public static DqCertDescriptorDTO newInstance(){
		return new DqCertDescriptorDTO();
	}
	/**
	...
	public void initPublicCert(String certPath) {
		if (!DqStringUtils.isEmpty(certPath)) {
