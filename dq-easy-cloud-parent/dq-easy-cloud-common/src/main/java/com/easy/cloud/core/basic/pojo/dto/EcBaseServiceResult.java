package com.dq.easy.cloud.module.basic.pojo.dto;
...
import com.dq.easy.cloud.module.exception.dto.DqBaseServiceResultException;
...
public class DqBaseServiceResult{
	...
	public static DqBaseServiceResult newInstanceOfSuccess(){
		...
		return dqBaseServiceResult.buildErrorCode(DqBaseErrorCodeEnum.SUCCESS);
	}
	/**
	 * <p>
