 ...
 * =============================================================================
 */
package com.easy.cloud.core.common.sign.dto;
 ...
 */
public class EcCertDescriptorDTO {
	protected static final Log log = LogFactory.getLog(EcCertDescriptorDTO.class);
	...
	public static EcCertDescriptorDTO newInstance(){
		return new EcCertDescriptorDTO();
	}
	/**
	...
	public void initPublicCert(String certPath) {
		if (!EcStringUtils.isEmpty(certPath)) {
