package com.easy.cloud.core.common.json.pojo.dto;
...
public class EcJsonFilterDTO {
	...
	public EcJsonFilterDTO(String key, Class<?> targetObjClass, String targetObjPropertyName,
