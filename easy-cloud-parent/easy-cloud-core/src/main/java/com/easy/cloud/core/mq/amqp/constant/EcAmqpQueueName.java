package com.easy.cloud.core.mq.amqp.constant;
...
public class EcAmqpQueueName {
	...
	public static enum EcAmqpQueueNameEnum {
		...
		// --------------------使用top机制的队列名称 begin----------------
		QUEUE_NAME_TOPIC_TEST(EcAmqpQueueName.QUEUE_NAME_TOPIC_TEST), 
		QUEUE_NAME_TOPIC_TESTS(EcAmqpQueueName.QUEUE_NAME_TOPIC_TESTS), 
		QUEUE_NAME_TOPICS(EcAmqpQueueName.QUEUE_NAME_TOPICS),
		// --------------------使用top机制的队列名称 end----------------

		// --------------------使用Fanout Exchange机制的队列名称 begin----------------
		QUEUE_NAME_FANOUT_TESTA(EcAmqpQueueName.QUEUE_NAME_FANOUT_TESTA), 
		QUEUE_NAME_FANOUT_TESTB(EcAmqpQueueName.QUEUE_NAME_FANOUT_TESTB), 
		QUEUE_NAME_FANOUT_TESTC(EcAmqpQueueName.QUEUE_NAME_FANOUT_TESTC),
		// --------------------验证Fanout Exchange机制的队列名称 end--------------
		;
