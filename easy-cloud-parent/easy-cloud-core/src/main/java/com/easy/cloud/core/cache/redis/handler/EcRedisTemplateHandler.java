...
public class EcRedisTemplateHandler {
	...
	public static void set(String key, Object obj){
		stringRedisTemplate.opsForValue().set(key, EcJSONUtils.parseObject(obj,String.class));
	}
	/**
	 * 
	...
	public static void set(String key, Object obj, long timeOut){
		stringRedisTemplate.opsForValue().set(key, EcJSONUtils.parseObject(obj,String.class), timeOut,TimeUnit.MILLISECONDS);
	}
	...
	public static void multiSet(Map<String,Object> multiMap){
		...
		for(String key : multiMap.keySet()){
			insertMultiMap.put(key, EcJSONUtils.parseObject(multiMap.get(key), String.class));
		}
	...
	public static void leftPush(String key, Object value){
		...
		if(value instanceof Collection || value instanceof Object[]){
			...
			stringRedisTemplate.opsForList().leftPush(key, EcJSONUtils.parseObject(value, String.class));
		}
	}
	/**
	 * 
	...
	public static void rightPush(String key, Object value){
		...
		if(value instanceof Collection || value instanceof Object[]){
			...
			stringRedisTemplate.opsForList().rightPush(key, EcJSONUtils.parseObject(value, String.class));
		}
	}
	...
	public static void setToList(String key, long index, Object value){
		...
		stringRedisTemplate.opsForList().set(key, index, EcJSONUtils.parseObject(value, String.class));
	}
	/**
	 * 
	...
	public static <T> T rightPopAndLeftPush(String sourceKey, String destinationKey, Class<T> clazz){
		...
		return EcJSONUtils.parseObject(stringRedisTemplate.opsForList().rightPopAndLeftPush(sourceKey, destinationKey), clazz);
	}
...
/**-------------------------------------map-----------------------------------*/
	...
	public static void putAllOfHash(String key, Map<Object,Object> hashMap){
		...
		for(Object hashKey : hashMap.keySet()){
			putHashMap.put(String.valueOf(hashKey), EcJSONUtils.parseObject(hashMap.get(hashKey), String.class));
		}
	...
	public static void putOfHash(String key, String hashKey, Object value){
		...
		stringRedisTemplate.opsForHash().put(key, hashKey, EcJSONUtils.parseObject(value, String.class));
	}
	/**
	 * 
...
/**	-----------------------------set----------------------------------------------------- */
	...
	public static long addOfSet(String key, Object value){
		...
		return stringRedisTemplate.opsForSet().add(key, EcJSONUtils.parseObject(value, String.class));
	}
	...
	public static Boolean isMemberOfSet(String key, Object obj){
		...
		return stringRedisTemplate.opsForSet().isMember(key, EcJSONUtils.parseObject(obj, String.class));
	}
	/**
	 * 
	...
	public static void setSerializer(String key,Object obj){
		redisTemlateValueSerializer.opsForValue().set(key, EcJSONUtils.parseObject(obj,String.class));
	}
