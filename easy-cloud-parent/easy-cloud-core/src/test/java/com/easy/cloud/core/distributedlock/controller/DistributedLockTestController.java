...
public class DistributedLockTestController {
    ...
    public String distributedLockTest(@RequestBody String id) throws Exception {
...
//        	Integer count1 = service.aspect(person);
            new Thread(new DistributedLockTestWorker(startSignal, doneSignal, service, redissonClient,id)).start();
        }
