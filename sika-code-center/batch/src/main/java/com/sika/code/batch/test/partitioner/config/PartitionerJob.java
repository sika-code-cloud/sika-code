package com.sika.code.batch.test.partitioner.config;

import com.sika.code.batch.test.partitioner.RangePartitioner;
import com.sika.code.batch.test.partitioner.User;
import com.sika.code.batch.test.partitioner.process.UserProcessor;
import com.sika.code.batch.test.partitioner.tasklet.DummyTasklet;
