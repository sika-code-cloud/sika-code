...
//		获取对类的日志开关
	 ...
	 * @return
	 * @author daiqi
	 * 创建时间    2018年2月9日 下午4:02:34
	 */
	public static DqLogEntruster getDqLogEntruster(DqLog dqLog){
		if (DqBaseUtils.isNull(dqLog)){
			return null;
		}
		if (DqBaseUtils.isNotNull(dqLog.dqLogEntrusterClass()) && DqBaseUtils.notEquals(dqLog.dqLogEntrusterClass(), DqLogBaseEntruster.class)){
