package com.easy.cloud.standard.rest.config;

import com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter;
import com.easy.cloud.standard.rest.interceptor.RestTemplateInterceptor;
import com.google.common.collect.Lists;
import com.easy.cloud.standard.rest.properties.RestTemplateProperties;
...
public class RestTemplateConfig {
    @Autowired
    private RestTemplateInterceptor actionTrackInterceptor;
     ...
     */
    public RestTemplate createRestTemplate(boolean userCustomerFactory, boolean addCustomerInterceptor) {
        ...
        if (addCustomerInterceptor) {
            // 把自定义的拦截器加到restTemplate中
