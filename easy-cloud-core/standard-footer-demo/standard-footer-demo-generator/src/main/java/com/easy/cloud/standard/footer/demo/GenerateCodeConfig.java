...
public class GenerateCodeConfig {
    ...
    private static String basePackagePathPrefixForJava = "src/main/java/com/easy/cloud/standard/footer/demo/business";
    private static String basePackagePathPrefixForXml = "src/main/resources/mapper";
    private static String modulePackage = "com.easy.cloud.standard.footer.demo";
