package com.easy.cloud.cache.redis.config;

import com.easy.cloud.cache.redis.aspect.RedisAspect;
import com.easy.cloud.cache.redis.selector.RedisProxySelector;
import com.easy.cloud.cache.redis.serializer.FastJson2JsonRedisSerializer;
 ...
 */
@Configuration
@ConditionalOnProperty(name = "easy.cloud.redis.fire", havingValue = "true")
