package com.easy.cloud.cache.redis.pojo.bo;

import com.easy.cloud.cache.redis.annotation.RedisAnnotation;
import com.easy.cloud.cache.redis.proxy.RedisProxy;
import com.easy.cloud.cache.redis.selector.RedisProxySelector;
import com.easy.cloud.basic.pojo.bo.BaseAspectBO;
import com.easy.cloud.cache.redis.pojo.dto.RedisDTO;
