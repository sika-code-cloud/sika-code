package com.easy.cloud.common.string.util;

import cn.hutool.core.util.StrUtil;
import com.easy.cloud.basic.util.BaseUtil;
import com.easy.cloud.common.array.ArrayUtil;
import com.easy.cloud.common.string.constant.StringConstant.Symbol;
...
public class StringUtil extends StrUtil {
     ...
     */
    public static final String EMPTY = Symbol.EMPTY;
    /**
     * 分割符---英文冒号---:
     */
    public static final String COLON = Symbol.COLON;
    /**
     * 初始化相关String容器的容量--32
     */
    ...
    public static String generateKeyUseColonSeparator(String... args) {
        return generateKey(Symbol.COLON, args);
    }
