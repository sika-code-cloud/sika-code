package com.easy.cloud.common.log.aspect;
...
public class ControllerLogAspect {
    ...
    @Pointcut("@annotation(com.easy.cloud.common.log.annotation.ControllerLog)")
    public void controllerLogMethodCut() {
    }

    @Pointcut("@within(com.easy.cloud.common.log.annotation.ControllerLog)")
