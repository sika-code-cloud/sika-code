package com.easy.cloud.common.http.util;
...
import com.easy.cloud.common.util.MapUtil;
...
public class RequestUtil extends HttpUtil {
    ...
    public static String buildRequestUrl(final String requestUrl, final Map<String, Object> requestParams) {
        ...
        if (!StringUtil.containsAny(requestUrl, Symbol.QUESTION_MARK)) {
            urlBuilder.append(Symbol.QUESTION_MARK);
        }
        boolean needSingleAnd = false;
        for (String name : requestParams.keySet()) {
            Object value = requestParams.get(name);
            if (needSingleAnd) {
                urlBuilder.append(Symbol.SINGLE_AND);
            }
