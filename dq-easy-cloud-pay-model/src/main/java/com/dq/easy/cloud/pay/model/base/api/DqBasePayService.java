...
public abstract class DqBasePayService extends DqBaseService implements DqPayService {
	 ...
	 */
	@Override
	public DqBasePayService setPayConfigStorage(DqPayConfigStorage payConfigStorage) {
		this.payConfigStorage = payConfigStorage;
		return this;
	}

	@Override
	public DqPayConfigStorage getPayConfigStorage() {
	 ...
	 */
	@Override
	public DqBasePayService setRequestTemplateConfigStorage(DqHttpConfigStorageDTO configStorage) {
		this.requestTemplate = new DqHttpRequestTemplateBO(configStorage);
		return this;
	}

	public DqBasePayService(DqPayConfigStorage payConfigStorage) {
		this(payConfigStorage, null);
	}

	public DqBasePayService(DqPayConfigStorage payConfigStorage, DqHttpConfigStorageDTO configStorage) {
