...
@PipelineName(value = "MyGithub")
@Gecco(matchUrl = "https://github.com/{user}/{project}", pipelines = "MyGithub")
public class MyGithub implements HtmlBean, Pipeline<MyGithub> {
	...
	public void process(MyGithub bean) {
		System.out.println("=========================================" + bean.getFork());
