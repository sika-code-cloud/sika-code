...
public class GenerateJavaTest {
	...
	// pojo类所在的项目名称
	private String projectNamePojo = "easy-cloud-core-reptile";
	// dao类所在的项目名称
	private String projectNameDao = "easy-cloud-core-reptile";
	// service类所在的项目名称
	private String projectNameService = "easy-cloud-core-reptile";
	// controller类所在的项目名称
	private String projectNameController = "easy-cloud-core-reptile";
	// mybatis配置文件所在的项目名称
	private String projectNameMybatis = "easy-cloud-core-reptile";
	// 基础包名称
