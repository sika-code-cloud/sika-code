...
import com.easy.cloud.core.worker.common.constant.EcWorkerConstant.EcJobType;
...
import com.easy.cloud.core.worker.job.impl.EcMqJob;
import com.easy.cloud.core.worker.job.impl.EcRedisJob;
import com.easy.cloud.core.worker.job.impl.EcRestJob;
...
public class EcCoreJob extends QuartzJobBean {
     ...
     * @return com.easy.cloud.core.worker.job.EcBaseJob
     * @author daiqi
