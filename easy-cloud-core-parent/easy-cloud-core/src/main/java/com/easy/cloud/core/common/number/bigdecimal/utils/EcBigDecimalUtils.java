package com.easy.cloud.core.common.number.bigdecimal.utils;
...
import com.easy.cloud.core.common.number.utils.EcNumberUtils;
 ...
 */
public class EcBigDecimalUtils extends EcNumberUtils {
	/** 数值为0的BigDecimal对象 */
	...
	public static BigDecimal mul(BigDecimal value1, BigDecimal value2){
		if (EcBaseUtils.isNull(value1) || EcBaseUtils.isNull(value2)) {
			return null;
		}
	...
	public static BigDecimal formatTwoScale(BigDecimal bigDecimal) {
		if (EcBaseUtils.isNull(bigDecimal)) {
			return null;
		}
