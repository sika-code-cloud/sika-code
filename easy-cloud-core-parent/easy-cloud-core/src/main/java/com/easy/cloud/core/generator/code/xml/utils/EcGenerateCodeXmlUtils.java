package com.easy.cloud.core.generator.code.xml.utils;
...
public class EcGenerateCodeXmlUtils {
	...
	public static String getMybatisColunmMappingPropertyByData(EcGenerateXmlMybatisData generateXmlMybatisData, String simpleTableName) {
		...
		if (EcStringUtils.isNotEmpty(simpleTableName)) {
			sb.append(simpleTableName).append(EcSymbol.STOP);
		}
		sb.append(generateXmlMybatisData.getColunmName());
		...
		sb.append(EcMyBatisAttrKey.JDBC_TYPE).append(EcSymbol.EQUAL).append(generateXmlMybatisData.getJdbcType());
