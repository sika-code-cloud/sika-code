...
package com.easy.cloud.core.common.encrypt.rsa.utils;

import javax.crypto.Cipher;

import com.easy.cloud.core.common.encrypt.base64.utils.EcBase64Utils;
 ...
 *
 * @author daiqi
 * 创建时间    2018年2月23日 下午2:34:09
 */
public class EcRSAUtils{
	...
	public static String sign(String content, String privateKey, String signAlgorithms, String characterEncoding) {
		try {
			PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(EcBase64Utils.decode(privateKey));
			...
			return EcBase64Utils.encode(signed);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	*/
	public static boolean verify(String content, String sign, String publicKey, String signAlgorithms, String characterEncoding){
		try {
	        ...
	        byte[] encodedKey 		= EcBase64Utils.decode(publicKey);
	        PublicKey pubKey 		= keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));
			java.security.Signature signature = java.security.Signature.getInstance(signAlgorithms);
			signature.initVerify(pubKey);
			signature.update( content.getBytes(characterEncoding) );
			return signature.verify( EcBase64Utils.decode(sign) );
		} catch (Exception e) {
			e.printStackTrace();
		}
		return false;
	...
	*/
	public static String decrypt(String content, String privateKey, String characterEncoding) throws Exception {
        ...
        InputStream ins 	= new ByteArrayInputStream(EcBase64Utils.decode(content));
	...
	*/
	public static PrivateKey getPrivateKey(String key) throws Exception {
		...
		byte[] keyBytes;
		keyBytes = EcBase64Utils.decode(key);
