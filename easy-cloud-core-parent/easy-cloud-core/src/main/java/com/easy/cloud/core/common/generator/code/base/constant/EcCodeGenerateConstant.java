package com.easy.cloud.core.common.generator.code.base.constant;
 ...
 */
public class EcCodeGenerateConstant {
	 ...
	 */
	public static class EcCodeProject {
		/** 项目根路径---基础路径---System.getProperty("user.dir") */
		public static final String PROJECT_ROOT_BASE_PATH_DEFAULT = EcFileConstant.USER_DIR;
	}
	
	public static class EcTemplateName {
		/** java文件的ftl */
	 ...
	 */
	public static class EcClassNameSimple {
		/** 类名简称---原始类型---byte */
	 ...
	 */
	public static class EcSourceCodeRelativePath {
	 ...
	 * @author daiqi 创建时间 2018年3月22日 下午5:28:11
	 */
	public static class EcColumnLabel {
