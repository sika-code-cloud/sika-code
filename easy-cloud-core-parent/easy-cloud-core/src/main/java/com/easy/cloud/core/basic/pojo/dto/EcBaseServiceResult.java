...
public class EcBaseServiceResult {
    ...
    public EcBaseServiceResult buildDqBaseErrorCodeInf(EcBaseErrorCodeInf ecBaseErrorCodeInf) {
        ...
        buildErrorCodeAndMsg(ecBaseErrorCodeInf.getErrorCode(), ecBaseErrorCodeInf.getErrorMsg());
        return this;
    }
    ...
    public EcBaseServiceResult buildSuccess(Boolean success) {
        this.success = success;
        return this;
    }

    public boolean getSuccess() {
        if (EcBaseUtils.isNotNull(success)) {
            return success;
        }
        return false;
    }
