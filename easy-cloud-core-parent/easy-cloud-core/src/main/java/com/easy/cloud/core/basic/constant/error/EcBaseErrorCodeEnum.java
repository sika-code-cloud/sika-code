...
public enum EcBaseErrorCodeEnum implements EcBaseErrorCodeInf{
	...
	/** 异常---列表为空异常---A_000012 */
	LIST_NULL("A_000012", "列表[%s]为空"),
	/** 异常---列表为空或者空列表异常---A_000013 */
	LIST_EMPTY("A_000013", "列表[%s]数据为空"),
	/** 异常---字符串为空或者空串异常---A_000014 */
	STR_EMPTY("A_000014", "[%s]字符串为空或者空串"),
	/** 异常---数据不存在异常---A_000015 */
	DATA_NON_EXISTENT("A_000015", "[%s]不存在"),
	/** 异常---数据存在异常---A_000016 */
	DATA_ALREADY_EXISTENT("A_000016", "[%s]已经存在"),
	/** 异常---数据有误异常---A_000017 */
	DATA_ERROR("A_000017", "[%s]有误")
	;
