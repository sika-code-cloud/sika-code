package com.easy.cloud.core.generator.code.xml.pojo.bo.mybatis;
...
import com.easy.cloud.core.generator.code.xml.constant.EcCodeGenerateXmlConstant.EcTableColumnKey;
import com.easy.cloud.core.generator.code.xml.desc.EcXmlContentElementDesc;
import com.easy.cloud.core.generator.code.xml.desc.EcXmlMybatisContentElementDesc;
import com.easy.cloud.core.generator.code.xml.pojo.bo.EcGenerateXmlBaseBO;
import com.easy.cloud.core.generator.code.xml.pojo.dto.EcGenerateXmlBaseDTO;
import com.easy.cloud.core.generator.code.xml.pojo.dto.EcGenerateXmlMybatisDTO;
import com.easy.cloud.core.generator.code.xml.pojo.dto.EcGenerateXmlMybatisData;
import com.easy.cloud.core.generator.code.xml.utils.EcGenerateCodeXmlUtils;
...
public class EcGenerateXmlMybatisBO extends EcGenerateXmlBaseBO {
	...
	protected void updateColumnListText(Element rootElement) {
	...
	/** 更新resultMap的子节点 */
	protected void updateReultMapChidren(Element rootElement) {
		...
		for (EcGenerateXmlMybatisData data : mybatisDTO.getDatas()) {
			...
			element.setAttribute(EcMyBatisAttrKey.JDBC_TYPE, data.getJdbcType());
	...
	public EcGenerateXmlMybatisBO buildResultMap() {
		...
		for (EcGenerateXmlMybatisData data : mybatisDTO.getDatas()) {
			...
			elementDesc.addAttribute(EcMyBatisAttrKey.JDBC_TYPE, data.getJdbcType());
	...
	public EcGenerateXmlMybatisBO buildSetColumnSql() {
		...
		setColumnSqlElement.setElementName(EcMyBatisElementNameEnum.SQL.getDesc());
	...
	private String getIfElementText(EcGenerateXmlMybatisData data) {
		return EcGenerateCodeXmlUtils.getMybatisColunmMappingPropertyByData(data, null)
				+ EcSymbol.COMMA;
	}
