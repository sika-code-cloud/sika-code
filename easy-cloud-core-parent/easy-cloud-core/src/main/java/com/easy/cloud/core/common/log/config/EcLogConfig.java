package com.easy.cloud.core.common.log.config;
...
public class EcLogConfig{
	...
	public static void setLogSwitchFlag(boolean switchFlag, String ... switchKeys){
		DQ_LOG_SWITCH_CONFIG.put(EcLogUtils.getLogKey(switchKeys), switchFlag);
	}
	...
	public static void setLogAnalysisSwitchFlag(boolean switchFlag, String ... switchKeys){
		DQ_LOG_ANALYSIS_SWITCH_CONFIG.put(EcLogUtils.getLogKey(switchKeys), switchFlag);
	}
