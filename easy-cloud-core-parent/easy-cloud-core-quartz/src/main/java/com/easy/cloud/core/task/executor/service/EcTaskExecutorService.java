package com.easy.cloud.core.task.executor.service;
...
public interface EcTaskExecutorService {
     ...
     * @return java.util.List<com.easy.cloud.core.task.executor.pojo.dto.EcTaskExecutorDTO>
     * @author daiqi
     ...
     *     taskExecutorDTO.jobCallbackClassName : com.easy.cloud.core.task.job.callback.impl.EcDefaultJobCallBackHandler : 异步回调执行handler : 否
     *     taskExecutorDTO.jobType : 1 : 工作类型 @see EcJobType常量类 : 否
     *     taskExecutorDTO.asyn : 1 : 是否为异步执行job 0同步 1为异步  默认异步: 否
     * </pre>
     *
     * @param taskExecutorDTO
     * @return com.easy.cloud.core.task.executor.pojo.dto.EcTaskExecutorDTO
     * @author daiqi
