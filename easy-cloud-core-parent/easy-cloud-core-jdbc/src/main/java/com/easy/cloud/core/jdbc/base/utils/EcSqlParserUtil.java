 ...
 * 
 */
public final class EcSqlParserUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println(EcSqlParserUtil.parseConditions("SELECT DISTINCT outbound_order.order_no FROM outbound_order INNER JOIN outbound_order_detail ON outbound_order.order_no = outbound_order_detail.order_no WHERE 1 = 1 AND (outbound_order.order_type = 'ORDER_TYPE_SO'  OR outbound_order.order_type = 'ORDER_TYPE_RO'  OR outbound_order.order_type = 'PR'  OR outbound_order.order_type = 'RTSG'  OR outbound_order.order_type = 'STO'  OR outbound_order.order_type = 'SAO'  OR outbound_order.order_type = 'JCK'  OR outbound_order.order_type = 'BO' ) AND (outbound_order_detail.Inventory_status = 'LOCATION_STATUS_QUALIFIED'  OR outbound_order_detail.Inventory_status IS NULL)  and outbound_order.order_no = @ORDER_NO and outbound_order_detail.order_line_no = @ORDER_LINE_NO "));
	}
}