package com.easy.cloud.core.oauth.authorize.client.zfb.pojo.dto;
 ...
 */
public class EcZfbAccessTokenDTO extends EcBaseAccessTokenDTO{
    public EcZfbAccessTokenDTO() {
    }

    public EcZfbAccessTokenDTO(Map<String, Object> accessTokenParam) {
