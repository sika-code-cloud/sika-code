package com.easy.cloud.core.oauth.authorize.client.zfb.token;
...
import com.easy.cloud.core.oauth.authorize.client.base.constant.EcOauthConstant.EcOauthAccessToken;
...
import com.easy.cloud.core.oauth.authorize.client.zfb.pojo.dto.EcZfbAccessTokenDTO;
import com.easy.cloud.core.oauth.authorize.client.zfb.request.builder.EcResourceZfbRequestBuilder;
import com.easy.cloud.core.oauth.authorize.client.zfb.request.builder.EcTokenZfbRequestBuilder;
...
public class EcZfbOauthToken extends EcBaseOauthToken {
    ...
    public Map<String, Object> doGetOauthAccessToken() throws Exception {
        ...
        if (oauthTokenResponse != null && oauthTokenResponse.isSuccess()) {
            ...
            throw new EcBaseBusinessException(EcBaseErrorCodeEnum.SYS_EXCEPTION).buildExceptionDetail(oauthTokenResponse);
        }
    }
    ...
    public EcBaseOauthResourceDTO doGetOauthResource(Map<String, Object> oAuthResponseParam) throws Exception {
        ...
        if (shareResponse != null && shareResponse.isSuccess()) {
            ...
            throw new EcBaseBusinessException(EcBaseErrorCodeEnum.SYS_EXCEPTION).buildExceptionDetail(shareResponse);
        }
    }
}
