 ...
 */
public abstract class EcBaseLockResultProcessor {
	 ...
	 */
	public final Object proceed(ProceedingJoinPoint pjp, EcLockResult distributedLockResult) {
		if (EcBaseUtils.isNull(distributedLockResult)) {
			throw new EcBaseBusinessException(EcLockErrorCodeEnum.LOCK_RESULT_CANT_NULL); 
		}
	 ...
	 */
	protected abstract Object success(ProceedingJoinPoint pjp, EcLockResult distributedLockResult);
	 ...
	 * @创建时间 2018年4月14日 上午10:31:40
	 */
	protected abstract Object fail(ProceedingJoinPoint pjp, EcLockResult distributedLockResult);
