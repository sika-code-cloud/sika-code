...
import com.cat.reconciliation.platform.interfaces.common.controller.BaseLiteflowServerController;
...
public class ${entity} extends BaseLiteflowServerController {
