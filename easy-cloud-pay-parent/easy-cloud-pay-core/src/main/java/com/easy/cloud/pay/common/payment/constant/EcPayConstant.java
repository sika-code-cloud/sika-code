 ...
 */
public class EcPayConstant extends EcBaseConstant{
	
	/** 支付键类 */
	public static class EcPayKey extends EcPayConstant{
	...
	/** 支付值类 */
	public static class EcPayValue extends EcPayConstant {
