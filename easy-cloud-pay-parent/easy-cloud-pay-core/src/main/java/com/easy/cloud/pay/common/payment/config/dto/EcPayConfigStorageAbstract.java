package com.easy.cloud.pay.common.payment.config.dto;
...
import com.easy.cloud.core.common.sign.dto.EcCertDescriptorDTO;
 ...
 */
public abstract class EcPayConfigStorageAbstract implements EcPayConfigStorageInf{

    private volatile Object attach;
    /**
     * 证书管理器
     */
    private volatile EcCertDescriptorDTO certDescriptorDTO;
     ...
     * 消息来源类型
     */
    private volatile EcMsgType EcMsgType;
    ...
    @Override
    public EcCertDescriptorDTO getCertDescriptor() {
        if (!isCertSign){
           throw EcBaseBusinessException.newInstance(EcPayErrorCodeEnum.PAY_CERTSIGN_IS_FLASE);
        }
        if (EcBaseUtils.isNull(certDescriptorDTO)){
        	certDescriptorDTO = EcCertDescriptorDTO.newInstance();
        }
        return certDescriptorDTO;
    }
	...
	public EcCertDescriptorDTO getEcCertDescriptorDTO() {
		return certDescriptorDTO;
	}

	public void setEcCertDescriptorDTO(EcCertDescriptorDTO EcCertDescriptorDTO) {
		this.certDescriptorDTO = EcCertDescriptorDTO;
	}

	public EcMsgType getEcMsgType() {
		return EcMsgType;
	}

	public void setEcMsgType(EcMsgType EcMsgType) {
		this.EcMsgType = EcMsgType;
	}
