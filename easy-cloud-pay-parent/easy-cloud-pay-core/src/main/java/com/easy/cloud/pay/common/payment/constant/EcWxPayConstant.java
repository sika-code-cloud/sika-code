package com.easy.cloud.pay.common.payment.constant;
 ...
 */
public class EcWxPayConstant extends EcPayConstant{
	
	/** 微信支付键的常量类 */
	public static class EcWxPayKey extends EcPayKey{
	...
	/** 微信支付值常量类 */
	public static class EcWxPayValue extends EcPayValue{
		...
		public static boolean isSUCCESS(Object statusCode){
			return EcBaseUtils.equals(EcWxPayValue.SUCCESS, statusCode);
		}
