 ...
 */
public enum EcPayErrorCodeEnum implements EcBaseErrorCodeInf{
	...
	PAY_ORDER_DTO_CANT_NULL ("PAY_000003", "支付订单数据传输对象不能为空"),
	...
	private EcPayErrorCodeEnum(String errorCode, String errorMsg) {
