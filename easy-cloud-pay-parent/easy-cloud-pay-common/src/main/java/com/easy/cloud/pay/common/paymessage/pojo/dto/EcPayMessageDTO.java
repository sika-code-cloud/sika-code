package com.easy.cloud.pay.common.paymessage.pojo.dto;
 ...
 */
public class EcPayMessageDTO implements Serializable {
    ...
    public EcPayMessageDTO(Map<String, Object> payMessage) {
        this.payMessage = payMessage;
    }

    public EcPayMessageDTO(Map<String, Object> payMessage, String payType, String msgType) {
        this(payMessage);
    ...
    public EcPayMessageDTO(Map<String, Object> payMessage, String msgType, String payType, String transactionType) {
        this.payMessage = payMessage;
        this.msgType = msgType;
        this.payType = payType;
