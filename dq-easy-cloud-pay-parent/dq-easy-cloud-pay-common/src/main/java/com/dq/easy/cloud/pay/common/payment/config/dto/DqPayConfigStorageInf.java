package com.dq.easy.cloud.pay.common.payment.config.dto;
 ...
 * 支付客户端配置存储
 */
 public interface DqPayConfigStorageInf {
     ...
     * @return 证书解释器
     */
     DqCertDescriptorDTO getCertDescriptor();
