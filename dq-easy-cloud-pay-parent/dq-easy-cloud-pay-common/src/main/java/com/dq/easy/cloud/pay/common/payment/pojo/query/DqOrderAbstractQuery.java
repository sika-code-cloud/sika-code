package com.dq.easy.cloud.pay.common.payment.pojo.query;
...
import com.dq.easy.cloud.pay.common.base.pojo.dto.DqBasePayDTO;
...
public abstract class DqOrderAbstractQuery extends DqBasePayDTO{
	...
	public DqOrderAbstractQuery verifyBillDate() {
		if (DqBaseUtils.isNull(this.getBillDate())) {
			throw DqBaseBusinessException.newInstance(DqPayErrorCodeEnum.BILL_DATE_CANT_NULL);
		}
		return this;
	}
	...
	public DqOrderAbstractQuery verifyBillType() {
		if (DqStringUtils.isEmpty(this.getBillType())) {
			throw DqBaseBusinessException.newInstance(DqPayErrorCodeEnum.BILL_TYPE_CANT_NULL);
		}
		return this;
	}
	...
	public DqOrderAbstractQuery verifyTradeNoOrBillDate() {
		if (DqBaseUtils.isNull(this.getTradeNoOrBillDate())) {
			throw DqBaseBusinessException.newInstance(DqPayErrorCodeEnum.TRADE_NO_OR_BILL_DATE_CANT_NULL);
		}
		return this;
	}
	...
	public DqOrderAbstractQuery verifyOutTradeNoBillType() {
		if (DqStringUtils.isEmpty(this.getOutTradeNoBillType())) {
			throw DqBaseBusinessException.newInstance(DqPayErrorCodeEnum.OUT_TRADE_NO_BILL_TYPE_CANT_NULL);
		}
		return this;
	}
	/** 校验退款订单号 */
