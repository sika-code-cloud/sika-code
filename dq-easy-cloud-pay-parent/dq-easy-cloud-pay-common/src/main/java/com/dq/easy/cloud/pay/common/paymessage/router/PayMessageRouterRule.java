package com.dq.easy.cloud.pay.common.paymessage.router;
...
import com.dq.easy.cloud.pay.common.payment.service.DqPayServiceInf;
import com.dq.easy.cloud.pay.common.paymessage.handler.PayMessageHandler;
import com.dq.easy.cloud.pay.common.paymessage.interceptor.PayMessageInterceptor;
...
public class PayMessageRouterRule {
	 ...
	 */
	public PayMessageRouterRule interceptor(PayMessageInterceptor interceptor,
			PayMessageInterceptor... otherInterceptors) {
	 ...
	 * @return 是否匹配通过
	 */
	protected boolean test(DqPayMessageDTO payMessage) {
	 ...
	 * @return 支付响应消息
	 */
	protected DqPayOutMessageDTO service(DqPayMessageDTO payMessage, DqPayServiceInf payService) {
