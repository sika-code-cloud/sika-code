package com.dq.easy.cloud.pay.common.paymessage.handler;
...
public interface PayMessageHandler {
	 ...
	 */
	DqPayOutMessageDTO handle(DqPayMessageDTO payMessage, Map<String, Object> context, DqPayServiceInf payService);
