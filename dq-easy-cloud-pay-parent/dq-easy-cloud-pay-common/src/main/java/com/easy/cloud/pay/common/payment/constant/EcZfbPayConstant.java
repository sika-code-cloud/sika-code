package com.dq.easy.cloud.pay.common.payment.constant;

import com.dq.easy.cloud.pay.common.payment.constant.DqPayConstant;
 ...
 */
public class DqZfbPayConstant extends DqPayConstant{
	
	/** 支付宝支付键的常量类 */
	public static class DqZfbPayKey extends DqPayKey{
	...
	/** 支付宝支付值常量类 */
	public static class DqZfbPayValue extends DqPayValue{
	...
	/** 支付宝产品代码常量类 */
	public static class DqZfbProductCode {
